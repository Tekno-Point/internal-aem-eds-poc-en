...
export default function decorate(block) {
  ...
  const pinInpDiv = div();
  const inpone = input({ type: 'text', placeholder: '0', maxlength: '1' });
  const inptwo = input({ type: 'text', placeholder: '0', maxlength: '1' });
  const inpthree = input({ type: 'text', placeholder: '0', maxlength: '1' });
  const inpfour = input({ type: 'text', placeholder: '0', maxlength: '1' });
  const inpfive = input({ type: 'text', placeholder: '0', maxlength: '1' });
  const inpsix = input({ type: 'text', placeholder: '0', maxlength: '1' });
